...
public class VentanaAdminGestionDepartamentoYEmpleado extends JDialog implements ActionListener {
	...
	public VentanaAdminGestionDepartamentoYEmpleado() {
		...
		lblNewLabel_1.setIcon(new ImageIcon(VentanaAdminGestionDepartamentoYEmpleado.class.getResource("/imgs/cruzRoja-32x32.png")));
		...
		btnGestiones.setIcon(new ImageIcon(VentanaAdminGestionDepartamentoYEmpleado.class.getResource("/imgs/gestiones.png")));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource().equals(btnDepartamentos)) {
			VentanaGestionDepartamentos VentanaGestionDepartamentos = new VentanaGestionDepartamentos(true);
