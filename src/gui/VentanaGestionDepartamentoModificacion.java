...
/**
 * Esta es la ventana donde se modifican los datos de un departamento de la aplicaci√≥n.
 * @author Julen
 *
 */
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource().equals(btnModificar)) {
			...
			if(!txtCdigoDelDepartamento.getText().isEmpty() || txtNombreDelDepartamento.getText().isEmpty()) {
				...
				int confirmado = JOptionPane.showConfirmDialog(this, "øEstas seguro de modificar este departamento?", "Modificaci√≥n",JOptionPane.OK_CANCEL_OPTION,  JOptionPane.INFORMATION_MESSAGE);
			...
			int confirmado = JOptionPane.showConfirmDialog(this,"øEstas seguro de cancelar la modificacion?", "Cancelar modificacion",JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
			if (JOptionPane.OK_OPTION == confirmado) {
				dispose();
			}
		}
